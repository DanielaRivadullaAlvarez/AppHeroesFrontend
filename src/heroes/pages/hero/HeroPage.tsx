              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center gap-4 ">
                    <div className="w-24 text-sm font-bold text-red-600">
                      Fuerza
                    </div>
                    ...
                    <div className="w-12 text-right font-bold  text-red-600">
                      {superheroData.strength}/10
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-24 text-sm font-bold text-purple-600">
                      Inteligencia
                    </div>
                    <div className="flex-1">
                      <Progress
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-24 text-sm font-bold text-yellow-600">Velocidad</div>
                    <div className="flex-1">
                      <Progress
                    ...
                    <div className="w-12 text-right font-bold text-yellow-600">
                      {superheroData.speed}/10
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="w-24 text-sm font-bold text-green-600">Resistencia</div>
                    <div className="flex-1">
                      <Progress
                        value={superheroData.durability * 10}
                        className="h-4"
                    ...
                    <div className="w-12 text-right font-bold text-green-600">
